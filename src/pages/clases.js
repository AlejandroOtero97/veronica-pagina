...
export default function Clases() {
  ...
  return (
    <section className="flex flex-col gap-8 max-w-5xl mx-auto">
      ...
      <footer className="px-8 py-10 sm:px-20 border-t border-[var(--color-primary-light)]/30 dark:border-[var(--color-primary-dark)]/30 text-sm">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-primary)] transition-colors">Instagram</a>
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-primary)] transition-colors">Facebook</a>
            <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-primary)] transition-colors">WhatsApp</a>
          </div>
